package com.example.favoritevacancy.data.repository
...
class FavoriteVacancyRepositoryImpl(
    ...
    override suspend fun saveFavorite(vacancy: FavoriteVacancyDomainModel) = withContext(Dispatchers.IO) {
        favoritesDao.upsertItem(vacancyDataMaper.mapToDatabase(vacancy))
    }

    override suspend fun deleteFavorite(vacancy: FavoriteVacancyDomainModel) = withContext(Dispatchers.IO) {
