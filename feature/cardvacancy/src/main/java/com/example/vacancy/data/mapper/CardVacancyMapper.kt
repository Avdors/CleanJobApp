package com.example.vacancy.data.mapper
...
import com.example.vacancy.domain.model.CardDomainAddressModel
import com.example.vacancy.domain.model.CardDomainExperienceModel
import com.example.vacancy.domain.model.CardDomainSalaryModel
...
class CardVacancyMapper {
    ...
    fun mapToFavoriteModel(vacancyModel: CardVacancyDomainModel): FavoriteVacModelDataBase {
        return FavoriteVacModelDataBase(
            ...
            address = AddressFModelDataBase(vacancyModel.address.town, vacancyModel.address.street, vacancyModel.address.house),
            company = vacancyModel.company,
            experience = ExperienceFModelDataBase(vacancyModel.experience.previewText, vacancyModel.experience.text),
            publishedDate = vacancyModel.publishedDate,
            isFavorite = vacancyModel.isFavorite,
            salary = SalaryFModelDataBase(vacancyModel.salary.full, vacancyModel.salary.short ?: ""),
